...
create table my_schema.pktable(ptest1 int, constraint pk_base1 primary key(base1),
...
CREATE TABLE hours_to_days_ancient PARTITION OF hours_to_days
    FOR VALUES in ('1988-01-01', '1989-01-01', '1990-01-01') FROM (minvalue) TO ('1990-01-01');

CREATE GLOBAL TEMPORARY TABLE if not exists films (
    code        char(5) CONSTRAINT firstkey PRIMARY KEY, /* some
    comment here */
    title       varchar(40) NOT NULL, -- line comment here
