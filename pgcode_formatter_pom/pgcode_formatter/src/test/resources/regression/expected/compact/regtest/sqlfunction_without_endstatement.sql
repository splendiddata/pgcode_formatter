...
RETURNS TABLE (
	...
	heap_blks_read BIGINT, heap_blks_read_delta BIGINT,
	heap_blks_hit BIGINT, heap_blks_hit_delta BIGINT,
	idx_blks_read BIGINT, idx_blks_read_delta BIGINT,
	idx_blks_hit BIGINT, idx_blks_hit_delta BIGINT,
	toast_blks_read BIGINT,
	toast_blks_read_delta BIGINT,
	toast_blks_hit BIGINT, toast_blks_hit_delta BIGINT,
	tidx_blks_read BIGINT, tidx_blks_read_delta BIGINT,
	tidx_blks_hit BIGINT, tidx_blks_hit_delta BIGINT,
	sample_time TIMESTAMPTZ )
AS $$
SELECT relid, schemaname, relname, heap_blks_read,
